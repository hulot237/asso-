...
class _HomeScreenState extends State<HomeScreen>
  ...
  // Fonction pour vérifier si une date est aujourd'hui ou dans le futur
  bool isDateTodayOrFuture(String dateString) {
    final format = DateFormat(
        "yyyy-MM-dd"); // Ajustez le format de date en fonction de vos données
  ...
  String selectedCategory = "Tout".tr();
                                                            ...
                                                            children: [
                                                              ...
                                                              BlocBuilder<
                                                                ...
                                                                return currentDetailtournoiCourant!["tournois"] != null &&
                                                                        currentDetailtournoiCourant["tournois"]["seance"].length >
                                                                            0 &&
                                                                        currentDetailtournoiCourant["tournois"]["seance"][0]["status"] ==
                                                                            1 &&
                                                                        !hasPassed48Hours(currentDetailtournoiCourant["tournois"]["seance"][0]
                                                                            [
                                                                            "date_seance"])
                                                                    ? GestureDetector(
                                                                        onTap:
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                            WidgetRencontreCard(
                                                                          dateFinRencontreAPI:
                                                                              currentDetailtournoiCourant["tournois"]["seance"][0]["end_date"] ?? currentDetailtournoiCourant["tournois"]["seance"][0]["date_seance"],
                                                                          codeTournoi: AppCubitStorage()
                                                                              .state
                                                                              .codeTournois!,
                                                                          rapportUrl:
                                                                              currentDetailtournoiCourant["tournois"]["seance"][0]["rapport"],
                                                                          // typeRencontre: currentDetailtournoiCourant["type_rencontre"],
                                                                          screenSource:
                                                                              "home.meeting",
                                                                          typeRencontre:
                                                                              currentDetailtournoiCourant["tournois"]["seance"][0]["type_rencontre"],
                                                                          maskElt:
                                                                              true,
                                                                          codeSeance:
                                                                              currentDetailtournoiCourant["tournois"]["seance"][0]["seance_code"],
                                                                          ...
                                                                          heureRencontre:
                                                                              currentDetailtournoiCourant["tournois"]["seance"][0]["heure_debut"],
                                                                          identifiantRencontre:
                                                                              currentDetailtournoiCourant["tournois"]["seance"][0]["matricule"],
                                                                          isActiveRencontre:
                                                                              currentDetailtournoiCourant["tournois"]["seance"][0]["status"],
                                                                          lieuRencontre:
                                                                              currentDetailtournoiCourant["tournois"]["seance"][0]["localisation"],
                                                                          prenomRecepteurRencontre: currentDetailtournoiCourant["tournois"]["seance"][0]["membre"]["last_name"] == null
                                                                              ? ""
                                                                              : currentDetailtournoiCourant["tournois"]["seance"][0]["membre"]["last_name"],
                                                                          nomRecepteurRencontre: currentDetailtournoiCourant["tournois"]["seance"][0]["membre"]["first_name"] == null
                                                                              ? ""
                                                                              : currentDetailtournoiCourant["tournois"]["seance"][0]["membre"]["first_name"],
                                                                          photoProfilRecepteur: currentDetailtournoiCourant["tournois"]["seance"][0]["membre"]["photo_profil"] == null
                                                                              ? ""
                                                                              : currentDetailtournoiCourant["tournois"]["seance"][0]["membre"]["photo_profil"],
                                                                          dateRencontreAPI:
                                                                              currentDetailtournoiCourant["tournois"]["seance"][0]["date_seance"],
                                                                        ),
                                                                      ),
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          if (!context
                                                                            ...
                                                                            Material(
                                                                              child: InkWell(
                                                                                onTap: () async {
                                                                                  updateTrackingData("home.btnAddMeeting", "${DateTime.now()}", {});
                                                                                  launchWeb(
