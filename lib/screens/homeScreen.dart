                            ...
                            children: [
                              if (currentDetailUser!["is_saver"])
                                BlocBuilder<PretEpargneCubit, PretEpargneState>(
                                  builder:
                                      (PretEpargnecontext, PretEpargnestate) {
                                    if (PretEpargnestate.isLoadingEpargne ==
                                            true &&
                                    ...
                                    final epargne = PretEpargnecontext.read<
                                            PretEpargneCubit>()
                                        .state
                                        .epargne;
                                    return Container(
                              ...
                              if (currentDetailUser!["is_owe"])
                                BlocBuilder<PretEpargneCubit, PretEpargneState>(
                                    builder:
                                        (PretEpargnecontext, PretEpargnestate) {
                                  if (PretEpargnestate.isLoadingPret == true &&
                                  ...
                                  final pret = PretEpargnecontext.read<
                                          PretEpargneCubit>()
                                      .state
                                      .pret;
                                  return GestureDetector(
                                    onTap: () {
                                      Modal().showModalTransactionPret(context);
                                      context
                                          .read<PretEpargneCubit>()
                                          .getDetailPret(pret['loan_code']);
                                    },
                                    child: Container(
                                      margin: EdgeInsets.only(
                                        left: 8.w,
                                      ...
                                      child: Stack(
                                        children: [
                                          ...
                                          if (PretEpargnestate.isLoadingPret ==
                                                  true &&
                                              PretEpargnestate.pret != null)
                                            Center(
                                              child: Container(
                              ...
                              if (currentDetailUser!["is_inscription_payed"] ==
                                  0)
                                Container(
                                  margin: EdgeInsets.only(
                                    left: 8.w,
                                                    ...
                                                    child: WidgetRencontreCard(
                                                      ...
                                                      lieuRencontre:
                                                          currentDetailtournoiCourant[
                                                                  ...
                                                                  ["seance"][0]
                                                              ["localisation"],
                                                      prenomRecepteurRencontre: currentDetailtournoiCourant[
                                                                              "tournois"]
                                                                          [
                                                                          "seance"]
                                                                      [
                                                          ...
                                                          : currentDetailtournoiCourant[
                                                                  ...
                                                                  [0]["membre"]
                                                              ["last_name"],
                                                      nomRecepteurRencontre: currentDetailtournoiCourant[
                                                                              "tournois"]
                                                                          [
                                                                          "seance"]
                                                                      [
                                                          ...
                                                          : currentDetailtournoiCourant[
                                                                  ...
                                                                  [0]["membre"]
                                                              ["first_name"],
                                                      photoProfilRecepteur: currentDetailtournoiCourant[
                                                                              "tournois"]
                                                                          [
                                                                          "seance"]
                                                                      [
