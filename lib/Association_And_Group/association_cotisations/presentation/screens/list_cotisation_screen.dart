...
//                 CotisationState.allCotisationAss == null && CotisationState.collectes == null  )
//               return Container(
//                 child: EasyLoader(
...
//             final currentCollectes =
//                 context.read<CotisationCubit>().state.collectes!.collections;
...
//                     child: Row(
//                       children: [
//                         buildCotisationType("${"cotisation interne".tr()}"),
//                         buildCotisationType("${"cotisation externe".tr()}"),
//                       ],
//                     ),
//                   ),
//                   selectedCotisationType == "cotisation externe".tr()
//                       ? Expanded(
//                           child: currentCollectes!.length > 0
//                               ? Stack(
//                                   children: [
//                                     Column(
//                                       children: [
...
//                                                           itemCollecte
//                                                               .collectPayLink!,
//                                                       is_passed: itemCollecte
//                                                           .isPassed!,
//                                                       is_tontine: 0,
//                                                       description: itemCollecte
//                                                           .description!,
//                                                     ),
//                                                   );
//                                                 } else {
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: [
              Tab(text: "cotisation interne".tr()),
              Tab(text: "collecte externe".tr()),
            ],
          ),
          leading: InkWell(
            onTap: () {
