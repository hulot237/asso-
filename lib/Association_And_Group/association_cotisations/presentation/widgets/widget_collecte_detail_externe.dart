...
class WidgetCollecteDetailExterne extends StatefulWidget {
  WidgetCollecteDetailExterne({
    super.key,
  ...
  @override
  State<WidgetCollecteDetailExterne> createState() =>
      _WidgetCollecteDetailExterneState();
}

class _WidgetCollecteDetailExterneState
    extends State<WidgetCollecteDetailExterne> {
