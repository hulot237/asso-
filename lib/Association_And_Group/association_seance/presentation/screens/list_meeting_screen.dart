              ...
              ? Stack(
                  children: [
                    Column(
                      ...
                      (selectedCategory == "En cours" && itemSeance["status"] == 1 && !isPasseDate(itemSeance["date_seance"])) ||
                      (selectedCategory == "Terminé" && (itemSeance["status"] == 0 || isPasseDate(itemSeance["date_seance"])))) {
                                  return Container(
                    ...
                    //             ),
                    //             // height: 15.h, // Utilisation de flutter_screenutil pour définir la hauteur
                    ...
                    //                   ),
                    //               ), // Texte à afficher dans le conteneur
                    //             ),
                    //           ),Container(
                    //             decoration: BoxDecoration(
                    ...
                    //           bottom: Platform.isIOS ? 70.h : 0.h,
                    //         ),
                    //         width: MediaQuery.of(context).size.width,
                    //         child: ListView.builder(
                    //           padding: EdgeInsets.only(bottom: 30.h),
                    //           shrinkWrap: true,
                    //           itemCount: currentDetailtournoiCourant["tournois"]["seance"].length,
                    //           itemBuilder: (context, index) {
                    //             final itemSeance = currentDetailtournoiCourant["tournois"]["seance"][index];
  ...
  Widget buildCategoryButton(String category) {
    return GestureDetector(
      onTap: () {
        setState(() {
          selectedCategory =
              category; // Mettre à jour la catégorie sélectionnée
        });
      },
      child: Container(
        padding: EdgeInsets.symmetric(vertical: 5.h, horizontal: 10.w),
        margin: EdgeInsets.only(top: 10.h, bottom: 0, left: 15.w,),
        decoration: BoxDecoration(
    ...
    @override
  void dispose() {
    _scrollController.dispose(); // Libérer le contrôleur de défilement lorsqu'il n'est plus utilisé
    super.dispose();
  }
}
