...
class widgetRecentEventCotisation extends StatefulWidget {
  ...
  @override
  State<widgetRecentEventCotisation> createState() => _widgetRecentEventCotisationState();
}
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              child: Text(
                                widget.type == "0"?
                                "Cotisation_fixe".tr() : "Cotisation_volontaire".tr(),
                                style: TextStyle(
                                  fontSize: 12,
