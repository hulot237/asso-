  ...
  Widget build(BuildContext context) {
    return BlocBuilder<UserGroupCubit, UserGroupState>(
      ...
      return GestureDetector(
        ...
        child: Container(
          padding: EdgeInsets.only(top:10.h, left: 10.w,right: 10.w, bottom: 0.h,),
                          ...
                          if (!context
                            ...
                            // if (widget.isSanctionPayed == 0)
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    Modal().showModalPaySanction(context, widget.nomProprietaire, widget.resteAPayer, widget.codeCotisation, widget.membreCode, widget.type, widget.libelleSanction, AppCubitStorage().state.codeTournois);
                                  },
                                  child: Column(
                                    children: [
                                      Container(
